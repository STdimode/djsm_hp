...
import heroImg from "figma:asset/56d4c81500cc6e941f92910cb4cf004eb75bf8bc.png";
import churchSchoolBg from "figma:asset/ebca73308d3ec6ec07e3882fa50bd0f0704c63c1.png";
  ...
  return (
    <div style={{ fontFamily: FONT, overflowX: "hidden" }}>
      ...
      <section
        ...
        style={{
          backgroundImage: `url(${churchSchoolBg})`,
          backgroundSize: "cover",
          backgroundPosition: "center",
        }}
      >
        ...
        <div className="relative max-w-[1440px] mx-auto px-4 md:px-8 text-center">
          <FadeUp>
            <h2 style={{ color: "white", fontSize: "1.77rem", fontWeight: 700, marginBottom: 12 }}>대전서문교회 다음세대</h2>
            <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "1rem", marginBottom: 32 }}>하나님을 바르게 알고 성장하며 신앙과 삶을 연결하도록 돕습니다.</p>
          </FadeUp>
